...
var putExpert = async (expert) =>{
  try{
    var updateUser=await db.executeStatement(`UPDATE users SET userName = '${expert.userName}' , userPassword = '${expert.userPassword}' , city = ${expert.city} , imgUrl = '${expert.imgUrl}' WHERE id = ${expert.id}`);
